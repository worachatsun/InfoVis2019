...
KVS.THREEScreen.prototype = {
  ...
  init: function(a, c) {
    ...
    this.camera = new THREE.PerspectiveCamera(45, b, 0.1, e);
    ...
    this.renderer.setClearColor(
      new THREE.Color(0.828125, 0.86328125, 0.89453125)
    );
...
KVS.ToTHREELine = function(a) {
  ...
  return new THREE.Line(
    c,
    f,
    a.line_type == KVS.StripLine ? THREE.LineStrip : THREE.LineSegments
  );
};

KVS.ToTHREEMesh = function(a, m = null) {
  var c = new THREE.Geometry(),
  ...
  if (0 == a.colors.length) f.color = new THREE.Color("white");
    ...
    (e = a.colors[0]), (f.color = new THREE.Color(e[0], e[1], e[2]));
  else if (a.colors.length == a.coords.length)
